...
const items = getProjectsByCategory("marketing");

const CARD_IMAGES = [
  "/home/thumbnails/Latitude-thumbnail.jpg",
  "/home/thumbnails/1818-thumbnail.jpg",
  "/home/thumbnails/BPD-thumbnail.jpg",
  "",  // Burquitlam Park District — not yet uploaded
];

const CARD_BG = [
  "linear-gradient(160deg, #1a1a18 0%, #202018 100%)",
  "linear-gradient(160deg, #121820 0%, #141b25 100%)",
  "linear-gradient(160deg, #16181a 0%, #1b1e20 100%)",
];
    ...
    <section style={{
      ...
      >
        ...
        <h2 style={{
          ...
          Campaigns that turn{" "}
          <strong style={{ fontWeight: 700, fontStyle: "italic", fontFamily: "var(--font-baskerville), Georgia, serif" }}>attention</strong> into{" "}
          <strong style={{ fontWeight: 700, fontStyle: "italic", fontFamily: "var(--font-baskerville), Georgia, serif" }}>intent.</strong>
        </h2>
      </motion.div>
      </div>
